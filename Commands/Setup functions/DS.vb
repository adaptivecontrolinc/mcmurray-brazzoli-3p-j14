...
Public Class DS : Inherits MarshalByRefObject : Implements ACCommand
  ...
  Sub ParametersChanged(ByVal ParamArray param() As Integer) Implements ACCommand.ParametersChanged
    With ControlCode
      ...
      If .Parameters_ReelSpeedMaximumYPM > 0 Then
        DSSpeed = param(1) * 10 + param(2)
      Else
        DSSpeed = .Parameters_ReelSpeedDefault
      End If
    End With
  End Sub
